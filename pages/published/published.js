...
Page({
   ...
   */
  data: {
    shalou: app.globalData.apiImgUrl + "lpy/shalou.png",
    refresh: false,
    nowtime: "",
    footerActive: "member",
    areaLists: ["全国", "省"],
    ...
    publishedImg: {
      ...
      info: app.globalData.apiImgUrl + "published-info.png",
    },
    newTopShow: false,
  ...
  initPublishedData: function (options) {
    if (options && options.hasOwnProperty("type")) {
      ...
      wx.setNavigationBarTitle({
        title: (options.type == "1") ? "鱼泡网-我发布的二手交易" : "鱼泡网-我发布的招工"
      })
    }
